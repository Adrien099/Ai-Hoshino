...
if (!text) return m.reply('🚩 Example Enter the name of the image you are looking for.\n\n`Example:`\n' + `> *${usedPrefix + command}* Ai Hoshino Icons`)
...
if (prohibited.some(word => m.text.toLowerCase().includes(word))) return m.reply('Enter the name of the image you are looking for .').then(_ => m.react('✖️'))
await m.react('🕓')
try {
